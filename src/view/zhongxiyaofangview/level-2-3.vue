  ...
  <div>
    ...
    <v-dialog v-model="dialog" max-width="800px">
      <template v-slot:activator="{ on }">
        <v-btn color="primary" dark class="mb-2" v-on="on">创建医疗卡</v-btn>
        ...
        <v-card-text>
          <v-container grid-list-md>
            <v-layout wrap>
              ...
              <v-flex xs12 sm6 md4>
                <v-text-field v-model="editedItem.person" label="持卡人"></v-text-field>
              </v-flex>
              <v-flex xs12 sm6 md4>
                <v-text-field v-model="editedItem.flag" label="状态"></v-text-field>
              </v-flex>
              <v-flex xs12 sm6 md4>
                <v-text-field v-model="editedItem.time1" label="日期"></v-text-field>
              </v-flex>
            </v-layout>
          </v-container>
        </v-card-text>
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: '持卡人', value: 'person' },
      { text: '金额(元)', value: 'money' },
      { text: '状态', value: 'flag' },
      { text: '创建时间', value: 'time1' },
